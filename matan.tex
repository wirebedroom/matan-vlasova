...
\end{theorem}
\begin{proof}
	"От противного". Предположим, что $\exists \lim_{n \to \infty} x_{n} = a$ и $\exists \lim_{n \to \infty} x_{n} = b$ и $a\neq b$. Пусть для определенности $a<b$.
	\[
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
Выберем $\varepsilon = \frac{b-a}{4} > 0$. Найдем $N_1(\varepsilon), N_2(\varepsilon), N=\max\{N_1, N_2\}$
\end{proof}
