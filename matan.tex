...
Такая $c$ является предельной точкой множества $X$.
\[
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
Отрезок $I_n$ содержит бесконечно много элементов множества $X$ по построению последовательности $\{x_n\}_{n=1}^{\infty} \implies$ окрестность $U(c)$ содержит бесконечно много элементов из $X \implies c$ --- предельная.
\end{proof}
