...
\\[12pt]
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\node[circle,draw=black,fill=white,inner sep=0pt,minimum size=3.5pt] (a) at (6,0) {};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw (6,0) node[anchor=north] (a) {$a$};
			\draw (9,0) node[anchor=north] (a+d) {$a+\delta$};
			\draw[black, fill=white] (6,0) circle (0.05) node[anchor=north] (a) {$a$};
		\end{tikzpicture}
	\end{center}
	...
	\begin{center}
		\begin{tikzpicture}
			...
			\draw[black, fill=white] (5,0) circle (0.05) node[anchor=north] (-d) {$-\delta$};
			\draw[black, fill=white] (7,0) circle (0.05) node[anchor=north] (d) {$\delta$};
		\end{tikzpicture}
	\end{center}
	\[
	x \in \accentset{\circ}{U}_\delta(+\infty)
	...
	\begin{center}
		\begin{tikzpicture}
			% Декартова плоскость.
			\draw[-{Classical TikZ Rightarrow[length=1mm]}] (1,4) -- (11,4);	
			\draw (11,4) node[anchor=north] (x) {$x$};
			\draw[-{Classical TikZ Rightarrow[length=1mm]}] (6,0) -- (6,8);	
			\draw (6,8) node[anchor=west] (y) {$y$};
			%\draw plot [smooth] coordinates {(6,4) (7,4.6) (8,6) (9,7.8) };
			%\draw[shift={(8,4)},color=black] (0pt,3pt) -- (0pt,-3pt) node[anchor=north] (a) {$a$};
			%\draw[shift={(7.3,4)},color=black] (0pt,3pt) -- (0pt,-3pt) node[anchor=north] (a-d) {$a-\delta$};
			%\draw[shift={(8.7,4)},color=black] (0pt,3pt) -- (0pt,-3pt) node[anchor=north] (a+d) {$a+\delta$};
		\end{tikzpicture}
	\end{center}
